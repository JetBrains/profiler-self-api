        ...
        return nativeMachine switch
          {
            ...
            _ => throw new ArgumentOutOfRangeException(nameof(nativeMachine), nativeMachine, null)
          };
      }
      ...
      return systemInfo.wProcessorArchitecture switch
        {
          ...
          _ => throw new ArgumentOutOfRangeException(nameof(systemInfo.wProcessorArchitecture), systemInfo.wProcessorArchitecture, null)
        };
    }
  }
}